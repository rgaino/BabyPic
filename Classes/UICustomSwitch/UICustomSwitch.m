...
{
	UICustomSwitch *switchView = [UICustomSwitch switchWithLeftText:leftText andRight:rightText andFrame:CGRectZero];	
	return switchView;
}

+(UICustomSwitch *)switchWithLeftText:(NSString *)leftText andRight:(NSString *)rightText andFrame:(CGRect) frame
{
	UICustomSwitch *switchView = [[UICustomSwitch alloc] initWithFrame:frame];
...
//	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,95,27)]))
    if ((self=[super initWithFrame:CGRectMake(rect.origin.x, rect.origin.y, 45, 24)]))
	{
...
-(void)awakeFromNib
{
	...
	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(4,0,42,24)];
	...
	self.leftLabel.frame = CGRectMake(5, 0, 48, 23);
	self.leftLabel.text = leftLabelText;
	self.leftLabel.textAlignment = UITextAlignmentCenter;
	self.leftLabel.font = [UIFont boldSystemFontOfSize:8];
	...
	self.rightLabel.frame = CGRectMake(90, 0, 48, 23);
	self.rightLabel.text = rightLabelText;
	self.rightLabel.textAlignment = UITextAlignmentCenter;
	self.rightLabel.font = [UIFont boldSystemFontOfSize:8];
